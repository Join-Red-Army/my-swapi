...
export const Intro = () => {
  return (
    <div className='intro'>
      <p>
        My Swapi - это написанное "с нуля" приложение для закрепления навыков работы с библиотеками React, Redux и Router. Используется база данных <a href='https://swapi.dev/'>swapi</a>. 
      </p>

      <p>
        Несмотря на внешнюю схожесть с приложением из <a href='https://www.udemy.com/course/pro-react-redux/'>курса</a> Юрия Буры "React + Redux", настоящее приложение и все его компоненты написаны с чистого листа. Единственный документ, который я заимствовал из курса - сервис, который делает Fetch-запросы (потому что он хорош).
      </p>
      ...
      <br/>Так, одна из проблем, с которыми я столкнулся на старте - когда и где делать сетевые запросы, а второй затуп произошёл с использованием функционала mapDispatchToProps. Но в итоге получилось со всем разобраться.
      </p>
